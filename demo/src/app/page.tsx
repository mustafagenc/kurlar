	...
	return (
		<div className="m-auto w-3xl my-10">
			...
			<div>
				...
				<p>Projeyi kullanmaya başlamak için aşağıdaki adımları izleyin:</p>
				<pre className="language-bash mt-5">
					<code>yarn add kurlar / npm i kurlar</code>
				</pre>
			</div>
			<div>
				<h3 className="text-xl font-bold mt-10 border-b-1 mb-2 pb-1">
				...
				<p>Projenizi başlatmak için aşağıdaki kodu kullanabilirsiniz:</p>
				<pre className="language-typescript mt-5">
					<code>
